...
class FailedUpdatesScreenModel(
    ...
    private fun simplifyErrorMessage(exception: String, isOnline: Long): String {
        return when (exception) {
            ...
            "SocketException" -> "context.getString(MR.strings.exception_socket_error)"
            "BindException" -> "context.getString(MR.strings.exception_bind_port)"
            "InterruptedIOException" -> "context.getString(MR.strings.exception_io_interrupted)"
            "HttpRetryException" -> "context.getString(MR.strings.exception_http_retry)"
            "PortUnreachableException" -> "context.getString(MR.strings.exception_port_unreachable)"
            // General IO-related exceptions
            "IOException" -> if (isOnline ==
                1L
            ) {
                "context.getString(MR.strings.exception_io_error)"
            } else {
                "context.getString(MR.strings.exception_internet_connection)"
            }
            "TimeoutException" -> "context.getString(MR.strings.exception_timed_out)"
            // SSL & Security-related
            "SSLException" -> "context.getString(MR.strings.exception_ssl_connection)"
            "CertificateExpiredException" -> "context.getString(MR.strings.exception_ssl_certificate)"
            "CertificateNotYetValidException" -> "context.getString(MR.strings.exception_ssl_not_valid)"
            "CertificateParsingException" -> "context.getString(MR.strings.exception_ssl_parsing)"
            "CertificateEncodingException" -> "context.getString(MR.strings.exception_ssl_encoding)"
            "UnrecoverableKeyException" -> "context.getString(MR.strings.exception_unrecoverable_key)"
            "KeyManagementException" -> "context.getString(MR.strings.exception_key_management)"
            "NoSuchAlgorithmException" -> "context.getString(MR.strings.exception_algorithm)"
            "KeyStoreException" -> "context.getString(MR.strings.exception_keystore)"
            "NoSuchProviderException" -> "context.getString(MR.strings.exception_security_provider)"
            "SignatureException" -> "context.getString(MR.strings.exception_signature_validation)"
            "InvalidKeySpecException" -> "context.getString(R.string.exception_key_specification)"
            // Host & DNS-related
            "UnknownHostException" -> if (isOnline ==
                1L
            ) {
                "context.getString(MR.strings.exception_domain)"
            } else {
                "context.getString(MR.strings.exception_internet_connection)"
            }
            "NoRouteToHostException" -> "context.getString(MR.strings.exception_route_to_host)"
            // URL & URI related
            "URISyntaxException" -> "context.getString(MR.strings.exception_uri_syntax)"
            "MalformedURLException" -> "context.getString(MR.strings.exception_malformed_url)"
            // Authentication & Proxy
            "ProtocolException" -> "context.getString(MR.strings.exception_protocol_proxy_type)"
            // Concurrency & Operation-related
            "CancellationException" -> "context.getString(MR.strings.exception_cancelled)"
            "InterruptedException" -> "context.getString(MR.strings.exception_interrupted)"
            "IllegalStateException" -> "context.getString(MR.strings.exception_unexpected_state)"
            "UnsupportedOperationException" -> "context.getString(MR.strings.exception_not_supported)"
            "IllegalArgumentException" -> "context.getString(MR.strings.exception_invalid_argument)"
            else -> ""
        }
    }
